...
## Installation
```
git clone https://github.com/radu2022/simple_shell.git
cd simple_shell
gcc *.c -o hsh
```
...
## Authors
* [Amanuel Mekonnen Gebretsadik](https://github.com/AmanKiya)
* [Seid Hamid Muhammed](https://github.com/radu2022)
